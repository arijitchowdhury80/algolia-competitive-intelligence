...
WRAPPER_INVARIANTS = {
    ...
    "wrapper missing Phase 8 review packet export": "export_argus_recommendation_review_packet.py",
    "wrapper missing Phase 8 PMM work artifact export": "export_pilot_recommendation_work_artifact.py",
    "wrapper missing Phase 8 PMM disposition request build": "build_phase8_disposition_request.py",
    "wrapper missing Phase 8 PMM work artifact publication": "publish_pilot_recommendation_work_artifact.py",
    "wrapper missing Phase 8 PMM work artifact output": "argus-pmm-narrative-brief.json",
