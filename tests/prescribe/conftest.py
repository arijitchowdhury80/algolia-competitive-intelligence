"""Shared fakes for prescribe tests: an in-memory BrainModel, matching the
convention in tests/brain/conftest.py and tests/horizon/conftest.py exactly
(no network/DB)."""
...
class FakeModel:
    ...
    async def generate(self, request: ModelRequest) -> ModelResponse:
        ...
        item = self._responses.pop(0) if self._responses else {"prescriptions": []}
